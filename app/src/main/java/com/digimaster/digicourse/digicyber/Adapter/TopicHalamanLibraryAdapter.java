...
public class TopicHalamanLibraryAdapter extends RecyclerView.Adapter<TopicHalamanLibraryAdapter.MyCoursesHolder> {
    ...
    public TopicHalamanLibraryAdapter(Context context, List<TopicDetailItem> dataItem, AdapterOnItemClickListener listener) {
    ...
    @Override
    public TopicHalamanLibraryAdapter.MyCoursesHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.topic_adapter_item, parent, false);

        return new TopicHalamanLibraryAdapter.MyCoursesHolder(itemView, mListener);
    }


    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(final TopicHalamanLibraryAdapter.MyCoursesHolder holder, @SuppressLint("RecyclerView") final int position) {
