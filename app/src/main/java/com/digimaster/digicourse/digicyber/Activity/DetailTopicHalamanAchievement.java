...
import com.digimaster.digicourse.digicyber.Fragment.ListTopicHalamanAchievement;
...
public class DetailTopicHalamanAchievement extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        adapter.AddFragment(new ListTopicHalamanAchievement(),"Topics");
                ...
                .enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(DetailTopicHalamanAchievement.this,modulename, Toast.LENGTH_SHORT).show();
                            try {
