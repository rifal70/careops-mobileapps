...
import com.digimaster.digicourse.digicyber.Adapter.KlikListModuleHalamanAchievementAdapter;
...
public class ListModuleHalamanAchievement extends Fragment {
    String token, userid,courseid;
    AlertDialog loading;
    SecuredPreference pref;
    Context context;
    KlikListModuleHalamanAchievementAdapter onlineAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        onlineAdapter = new KlikListModuleHalamanAchievementAdapter(getActivity(), onlineItemList, genProductAdapterListener());
...
//        );
    ...
    public void loadOnCourse(){
        ...
        mApiService.getModulDetailAch(courseid,userid).enqueue(new Callback<CourseListModuleResponse>() {
            ...
            public void onResponse(@NonNull Call<CourseListModuleResponse> call, @NonNull Response<CourseListModuleResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    onlineAdapter = new KlikListModuleHalamanAchievementAdapter(getActivity(), dataItemList, genProductAdapterListener());
