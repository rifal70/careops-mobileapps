...
//import com.digimaster.digicourse.digicyber.Adapter.TopicHalamanLibraryAdapter;
import com.digimaster.digicourse.digicyber.Adapter.TopicHalamanLibraryAdapter;
...
public class DetailsTopicsLibraryDetails extends Fragment {
    String token, userid,courseid;
    SecuredPreference pref;
    Context context;
    BaseApiService mApiService;
    RecyclerView rvModules;
    TopicHalamanLibraryAdapter topicHalamanLibraryAdapter;
    ...
    public DetailsTopicsLibraryDetails() {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        topicHalamanLibraryAdapter = new TopicHalamanLibraryAdapter(getActivity(), topicDetailItemList, genProductAdapterListener());
//        mySwipeCourse = view.findViewById(R.id.swiperefreshFragModule);
        ...
        try {
            ...
            passing_module_id = pref.getString(PrefContract.module_id,"");        } catch (AppException e) {
            e.printStackTrace();
        }
...
//        );
    ...
    private void initItem() {
        ...
        mApiService.getModuleDetail2(passing_module_id, userid).enqueue(new Callback<TopicResponse>() {
            @Override
            public void onResponse(@NonNull Call<TopicResponse> call, @NonNull Response<TopicResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    topicHalamanLibraryAdapter = new TopicHalamanLibraryAdapter(getActivity(), topicDetailItemList, genProductAdapterListener());
                    rvModules.setAdapter(topicHalamanLibraryAdapter);
                    topicHalamanLibraryAdapter.notifyDataSetChanged();
