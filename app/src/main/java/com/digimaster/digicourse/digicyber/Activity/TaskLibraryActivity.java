...
public class TaskLibraryActivity extends AppCompatActivity {
    ...
    protected TaskLibraryAdapter mMyCourseAdapter;
                ...
                if (response.isSuccessful()) {
                    ...
                    if (jsonRESULTS.equals("Berhasil mengambil seluruh data")) {
                        ...
                        if(androidItems.size() == 0) {
                            ...
                            mMyCourseAdapter = new TaskLibraryAdapter(TaskLibraryActivity.this, androidItems, genProductAdapterListener());
                            rvDosen.setAdapter(mMyCourseAdapter);
