...
import com.digimaster.digicourse.digicyber.Adapter.LibraryDetailModuleAdapter;
...
public class DetailsModulLibraryDetails extends Fragment {
    String token, userid,moduleid;
    AlertDialog loading;
    SecuredPreference pref;
    Context context;
    LibraryDetailModuleAdapter onlineAdapter;
    BaseApiService mApiService;
    RecyclerView rvWishlist;
    RecyclerView.LayoutManager layoutManager;
    List<ModuleDetail2tem> onlineItemList = new ArrayList<>();
    Button btnDate;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.detail_library_details_fragment, null);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        rvWishlist = view.findViewById(R.id.rv_libmoduldetail);
        ...
        onlineAdapter = new LibraryDetailModuleAdapter(getActivity(), onlineItemList, genProductAdapterListener());
...
//        );
    ...
    public void loadOnCourse(){
        ...
        mApiService.getmoduldetail2(moduleid).enqueue(new Callback<ModuleDetail2temResponse>() {

            @Override
            public void onResponse(@NonNull Call<ModuleDetail2temResponse> call, @NonNull Response<ModuleDetail2temResponse> response) {
                if (response.isSuccessful()) {

                    //Log.d("logggN",""+response.body());
                    List<ModuleDetail2tem> dataItemList = response.body().getModuleDetail();
                    //Toast.makeText(context, ""+androidItemList, Toast.LENGTH_SHORT).show();
                    onlineAdapter = new LibraryDetailModuleAdapter(getActivity(), dataItemList, genProductAdapterListener());
...
//                        mySwipeLib.setRefreshing(false);
            ...
            @Override
            public void onFailure(Call<ModuleDetail2temResponse> call, Throwable t) {
                if (loading != null && loading.isShowing()) {
                    loading.dismiss();
//                    mySwipeLib.setRefreshing(false);
